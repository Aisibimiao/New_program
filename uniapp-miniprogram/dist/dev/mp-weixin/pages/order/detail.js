  ...
  setup(__props) {
    ...
    async function handleReceive() {
      ...
      common_vendor.index.showModal({
        ...
        success: async (res) => {
          if (res.confirm) {
            try {
              await api_order.receiveOrder(orderId.value);
              common_vendor.index.showToast({ title: "确认成功，交易完成", icon: "success" });
              setTimeout(() => {
                common_vendor.index.navigateBack();
              }, 1500);
            } catch (err) {
    ...
    async function handleShip() {
      ...
      common_vendor.index.showModal({
        ...
        success: async (res) => {
          if (res.confirm) {
            try {
              await api_order.shipOrder(orderId.value);
    ...
    return (_ctx, _cache) => {
      ...
      return common_vendor.e({
        ...
        v: ((_R = order.value) == null ? void 0 : _R.status) === "PENDING" && !isSeller.value
      }, ((_S = order.value) == null ? void 0 : _S.status) === "PENDING" && !isSeller.value ? {
        w: common_vendor.o(handleCancel)
      } : {}, {
        x: ((_T = order.value) == null ? void 0 : _T.status) === "PAID" && isSeller.value
      }, ((_U = order.value) == null ? void 0 : _U.status) === "PAID" && isSeller.value ? {
        y: common_vendor.o(handleShip)
      } : {}, {
        z: ((_V = order.value) == null ? void 0 : _V.status) === "PAID" && !isSeller.value
      }, ((_W = order.value) == null ? void 0 : _W.status) === "PAID" && !isSeller.value ? {} : {}, {
        A: ((_X = order.value) == null ? void 0 : _X.status) === "SHIPPED" && !isSeller.value
      }, ((_Y = order.value) == null ? void 0 : _Y.status) === "SHIPPED" && !isSeller.value ? {
        B: common_vendor.o(handleReceive)
      } : {}, {
        C: ((_Z = order.value) == null ? void 0 : _Z.status) === "SHIPPED" && isSeller.value
      }, ((__ = order.value) == null ? void 0 : __.status) === "SHIPPED" && isSeller.value ? {} : {});
    };
  }
});
